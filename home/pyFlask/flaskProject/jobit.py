...
vaga2 = Vaga('1','Soft', 'Engenheiro','Engenheiro','Junior','Texto da descrição da vaga', 'Principais Responsabilidades: Desenvolver designs e arquiteturas de software de alta qualidade. Escrever código limpo e escalável usando as linguagens .NET e C#. Colaborar com equipes multifuncionais para definir e entregar novas funcionalidades. Solucionar problemas, depurar e atualizar software existente. Requisitos: Graduação em Ciência da Computação ou área relacionada. Experiência comprovada como Engenheiro de Software ou função semelhante. Experiência em design e desenvolvimento de software em um ambiente orientado a testes. Proficiência no framework .NET e na linguagem de programação C#. Benefícios: Salário competitivo e bônus por desempenho. Plano de saúde e aposentadoria. Horários de trabalho flexíveis e opções de trabalho remoto. Oportunidades de crescimento e desenvolvimento profissional.', 'vaga')
vaga3 = Vaga('2','Soft', 'Engenheiro','Engenheiro','Junior','Texto da descrição da vaga', 'Principais Responsabilidades: Desenvolver designs e arquiteturas de software de alta qualidade. Escrever código limpo e escalável usando as linguagens .NET e C#. Colaborar com equipes multifuncionais para definir e entregar novas funcionalidades. Solucionar problemas, depurar e atualizar software existente. Requisitos: Graduação em Ciência da Computação ou área relacionada. Experiência comprovada como Engenheiro de Software ou função semelhante. Experiência em design e desenvolvimento de software em um ambiente orientado a testes. Proficiência no framework .NET e na linguagem de programação C#. Benefícios: Salário competitivo e bônus por desempenho. Plano de saúde e aposentadoria. Horários de trabalho flexíveis e opções de trabalho remoto. Oportunidades de crescimento e desenvolvimento profissional.', 'vaga')
vaga4 = Vaga('3','Soft', 'Engenheiro','Engenheiro','Junior','Texto da descrição da vaga', 'Principais Responsabilidades: Desenvolver designs e arquiteturas de software de alta qualidade. Escrever código limpo e escalável usando as linguagens .NET e C#. Colaborar com equipes multifuncionais para definir e entregar novas funcionalidades. Solucionar problemas, depurar e atualizar software existente. Requisitos: Graduação em Ciência da Computação ou área relacionada. Experiência comprovada como Engenheiro de Software ou função semelhante. Experiência em design e desenvolvimento de software em um ambiente orientado a testes. Proficiência no framework .NET e na linguagem de programação C#. Benefícios: Salário competitivo e bônus por desempenho. Plano de saúde e aposentadoria. Horários de trabalho flexíveis e opções de trabalho remoto. Oportunidades de crescimento e desenvolvimento profissional.', 'vaga')
vaga5 = Vaga('4','Soft', 'Engenheiro','Engenheiro','Junior','Texto da descrição da vaga', 'Principais Responsabilidades: Desenvolver designs e arquiteturas de software de alta qualidade. Escrever código limpo e escalável usando as linguagens .NET e C#. Colaborar com equipes multifuncionais para definir e entregar novas funcionalidades. Solucionar problemas, depurar e atualizar software existente. Requisitos: Graduação em Ciência da Computação ou área relacionada. Experiência comprovada como Engenheiro de Software ou função semelhante. Experiência em design e desenvolvimento de software em um ambiente orientado a testes. Proficiência no framework .NET e na linguagem de programação C#. Benefícios: Salário competitivo e bônus por desempenho. Plano de saúde e aposentadoria. Horários de trabalho flexíveis e opções de trabalho remoto. Oportunidades de crescimento e desenvolvimento profissional.', 'vaga')
...
@app.route('/login')
def login():
  return render_template('source/login.html', vagas=vagas)
